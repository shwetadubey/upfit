...
foreach ( $items as $item_id => $item ) :
	...
	if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
        ...
        if ( ! empty( $item['commission_id'] ) ) {
            echo "\n" . _x( 'Commission id:', 'New Order Email', 'yith_wc_product_vendors' ) . ' ' . $commission->id . ' (' . $commission->get_view_url( 'admin' ) . ')';
            echo "\n" . _x( 'Commission rate:', 'New Order Email', 'yith_wc_product_vendors' ) . ' ' . $commission->rate;
            echo "\n" . _x( 'Earnings:', 'New Order Email', 'yith_wc_product_vendors' ) . ' ' . $commission->amount;
        }
