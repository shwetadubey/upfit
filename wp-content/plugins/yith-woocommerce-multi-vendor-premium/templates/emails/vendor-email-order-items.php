...
<?php foreach ( $items as $item_id => $item ) :
	...
	if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
		...
		<tr class="<?php echo esc_attr( apply_filters( 'woocoomerce_order_item_class', 'order_item', $item, $order ) ); ?>">
            ...
            <td style="text-align:center; vertical-align:middle; border: 1px solid #eee;"><?php echo $commission->rate * 100; ?>%</td>
            <td style="text-align:left; vertical-align:middle; border: 1px solid #eee;"><?php echo wc_price( $commission->amount ); ?></td>
		</tr>
		<?php
	}
