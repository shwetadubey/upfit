...
<div class="wrap yith-vendor-admin-wrap" id="vendor-details">
    <form method="post" action="admin.php" enctype="multipart/form-data">
        <h3><?php _e( 'Seller vacation info', 'yith_wc_product_vendors' ) ?></h3>
        ...
        <div class="form-field">
            <label for="vacation_message"><?php  _e( 'Vacation message:', 'yith_wc_product_vendors' ) ?></label>
            ...
            <br/>
            <span class="description"><?php _e( "Add here the vacation message.", 'yith_wc_product_vendors' ); ?></span>
        </div>

        <div class="form-field vacation-date">
            <h3><?php _e( 'Vacation date', 'yith_wc_product_vendors' ) ?></h3>
            <span class="vacation-date-field">
                <label for="vacation-start-date"><?php _e( 'Start date', 'yith_wc_product_vendors' ); ?></label>
            ...
            <span class="vacation-date-field">
                <label for="vacation-end-date"><?php _e( 'End date', 'yith_wc_product_vendors' ); ?></label>
         ...
         <div class="form-field">
            <label for="vacation_selling"><?php _e( 'Selling option', 'yith_wc_product_vendors' ); ?></label>
            <select name="yith_vendor_data[vacation_selling]" id="vacation_selling" style="width:250px;">
                <option value="disabled" <?php selected( 'disabled', $vendor->vacation_selling )?>><?php _e( 'Prevent sales temporarily', 'yith_wc_product_vendors' )?></option>
                <option value="enabled" <?php selected( 'enabled', $vendor->vacation_selling )?>><?php _e( 'Keep selling anyway', 'yith_wc_product_vendors' )?></option>
            </select>
        </div>

        <div class="submit">
            <input name="Submit" type="submit" class="button-primary" value="<?php echo esc_attr( __( 'Save Vacation Settings', 'yith_wc_product_vendors' ) ) ?>" />
        </div>
    </form>
</div>
