...
class YITH_Report_Sale_Commissions extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			'title'            => sprintf( __( '%s commission amount', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_all_amount ). '</strong>' ),
			'placeholder'      => __( 'This is the sum of commission totals.', 'yith_wc_product_vendors' ),
			'color'            => $this->chart_colours['commissions_amount'],
			'highlight_series' => 1
		);

        $legend[] = array(
			'title'            => sprintf( __( '%s paid commissions', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_paid_amount ). '</strong>' ),
			'placeholder'      => __( 'This is the sum of paid commission totals.', 'yith_wc_product_vendors' ),
			'color'            => $this->chart_colours['commissions_paid'],
			'highlight_series' => 2
		);

         $legend[] = array(
			'title'            => sprintf( __( '%s unpaid commissions', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_unpaid_amount ). '</strong>' ),
			'placeholder'      => __( 'This is the sum of unpaid commission totals.', 'yith_wc_product_vendors' ),
			'color'            => $this->chart_colours['commissions_unpaid'],
			'highlight_series' => 3
		);

         $legend[] = array(
			'title'            => sprintf( __( '%s processing commissions', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_processing_amount ). '</strong>' ),
			'placeholder'      => __( 'This is the sum of processing commission totals.', 'yith_wc_product_vendors' ),
			'color'            => $this->chart_colours['commissions_processing'],
			'highlight_series' => 4
		);

        $legend[] = array(
			'title'            => sprintf( __( '%s pending commissions', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_pending_amount ). '</strong>' ),
			'placeholder'      => __( 'This is the sum of pending commission totals.', 'yith_wc_product_vendors' ),
			'color'            => $this->chart_colours['commissions_pending'],
			'highlight_series' => 5
		);

        $legend[] = array(
			'title'            => sprintf( __( '%s commissions', 'yith_wc_product_vendors' ), '<strong>' . $count . '</strong>' ),
			'placeholder'      => __( 'This is the sum of the commissions in this period.', 'yith_wc_product_vendors' ),
			'color'            => $this->chart_colours['commissions_count'],
			'highlight_series' => 0
		);

        $legend[] = array(
            'title'            => sprintf( __( '%s refunded commissions', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_refunded_amount ). '</strong>' ),
            'placeholder'      => __( 'This is the sum of refunded commission totals.', 'yith_wc_product_vendors' ),
            'color'            => $this->chart_colours['commissions_refunded'],
            'highlight_series' => 6
        );

        $legend[] = array(
			'title'            => sprintf( __( '%s cancelled commissions', 'yith_wc_product_vendors' ), '<strong>' . wc_price( $data->commissions_cancelled_amount ). '</strong>' ),
			'placeholder'      => __( 'This is the sum of cancelled commission totals.', 'yith_wc_product_vendors' ),
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
                        {
							label: "<?php echo esc_js( __( 'Commission Totals', 'yith_wc_product_vendors' ) ) ?>",
							...
							shadowSize: 0,
							hoverable: true,
                            append_tooltip: "<?php echo ' ' . __( 'Commissions', 'yith_wc_product_vendors' ) ?>",
                            yaxis: 1
                        },
                        {
							label: "<?php echo esc_js( __( 'Commissions amount', 'yith_wc_product_vendors' ) ) ?>",
                        ...
                        {
							label: "<?php echo esc_js( __( 'Paid Commissions', 'yith_wc_product_vendors' ) ) ?>",
                        ...
                        {
							label: "<?php echo esc_js( __( 'Unpaid Commissions', 'yith_wc_product_vendors' ) ) ?>",
                        ...
                        {
							label: "<?php echo esc_js( __( 'Processing Commissions', 'yith_wc_product_vendors' ) ) ?>",
                        ...
                        {
							label: "<?php echo esc_js( __( 'Pending Commissions', 'yith_wc_product_vendors' ) ) ?>",
                        ...
                        {
							label: "<?php echo esc_js( __( 'Refunded Commissions', 'yith_wc_product_vendors' ) ) ?>",
                        ...
                        {
							label: "<?php echo esc_js( __( 'Cancelled Commissions', 'yith_wc_product_vendors' ) ) ?>",
