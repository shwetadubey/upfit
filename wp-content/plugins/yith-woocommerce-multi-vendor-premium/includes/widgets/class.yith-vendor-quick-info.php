...
if ( ! class_exists( 'YITH_Vendor_Quick_Info_Widget' ) ) {
    ...
    class YITH_Vendor_Quick_Info_Widget extends WP_Widget {
        ...
        public function __construct() {
            $this->response = array(
                0 => array(
                    'message' => __( 'Unable to send email. Please try again', 'yith_wc_product_vendors' ),
                    'class'   => 'error'
                ),
                1 => array(
                    'message' => __( 'Email sent successfully', 'yith_wc_product_vendors' ),
                    'class'   => 'message'
                ),
            );
            ...
            $name           = __( 'YITH Vendor Quick Info', 'yith_wc_product_vendors' );
            $widget_options = array(
                'description' => __( 'Add a quick info contact form in vendor\'s store page', 'yith_wc_product_vendors' )
            );
        ...
        public function form( $instance ) {
            $defaults = array(
                'title'             => __( 'Quick Info', 'yith_wc_product_vendors' ),
                'description'       => __( 'Do you need more information? Write to us!', 'yith_wc_product_vendors' ),
                'hide_from_guests'  => false,
                'cc_to_admin'       => false,
                'submit_label'      => __( 'Submit', 'yith_wc_product_vendors' ),
            );
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Description', 'yith_wc_product_vendors' ) ?>:
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'submit_label' ); ?>"><?php _e( 'Submit button label text', 'yith_wc_product_vendors' ) ?>:
             ...
             <p>
                <label for="<?php echo $this->get_field_id( 'hide_from_guests' ); ?>"><?php _e( 'Hide from guests', 'yith_wc_product_vendors' ) ?>:
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'cc_to_admin' ); ?>"><?php _e( 'Send a copy to website owner', 'yith_wc_product_vendors' ) ?>:
