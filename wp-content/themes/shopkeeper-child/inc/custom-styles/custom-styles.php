...
function shopkeeper_custom_styles() {	
	...
	<style>
		...
		.inp-s3-tital{color:<?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
		.right_content .welter_btn a {

		    border: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
		    background: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
		}
		.price_table.active .top_price,.drtooltip,ul.page-nav li.active a, ul.page-nav li:hover a {
		    background: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;
		}
		.price_table.active .center_description a { background: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		.testimonial_slider .white .wpb_content_element .testimonial_rotator_wrap .testimonial_rotator .has-image .text h2,.faq_show h3{color:<?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		.upfit_3_blocks .main_col .heading_warum,.box_wrapper h3,.details_overview > p{color:<?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
		.triangle_best, .price_table.active .border-triangle_best,.price_table:hover .top_price.top_price_best:after, .price_table.active .top_price:after, .price_table.active .border-triangle_best {   border-top-color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		ul#page-nav li.active a,.full-width-page #page-nav li a:hover,h2.form_heading{color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
/*		.toggle-btn:hover {border: solid 1px <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;   color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}*/
		.toggle-btn.success,.tipso_bubble {
		    border: solid 1px <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important; color: #fff;
		    background-color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		    label.circle_bg.tipso.tipso_style:hover {background-color:  <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
	    .gewicht_pat .gewicht_form .form_box li input.inp:hover {
		    border: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
		    color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
		}
		ul.page-nav li.active{    border: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
		ul.page-nav li.active a,.tooltipster-default,.tooltipster-base.tooltipster-default.tooltipster-fade.tooltipster-fade-show, .tooltipsterd-efault ,label.low-high_help:hover,.tipso_bubble{background: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
		.gewicht_pat .gewicht_form .form_box li input.inp:hover ~ span.input_kg{ color:<?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		.select2-drop.select2-drop-above.select2-drop-active {border: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
		.tooltipster-arrow-right span, .tooltipster-arrow-right .tooltipster-arrow-border{ border-color:<?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;}
		/*.section4 .inp-s3 .snuts.active:hover i,
		  ...
		  background: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> url("images/arrow_drop_down_hover.png") no-repeat scroll center -34px !important;
		  border: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
		}*/
		.tipso_bubble.right .tipso_arrow{border-color: transparent  <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> transparent transparent !important;}
		.toggle-btn-grp.joint-toggle .toggle-btn:first-child:hover ~ .toggle-btn:nth-child(2),.toggle-btn-grp.joint-toggle .toggle-btn:nth-child(2):hover ~ .toggle-btn{border-left: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		.drtooltip .arrow_bottom { border-top: 5px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		.price_table.active .border-triangle{border-top-color:<?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;}
		
		
		.gewicht_pat .gewicht_form .form_box li input.inp:hover::-webkit-input-placeholder { color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>  ; }
		.gewicht_pat .gewicht_form .form_box li input.inp:hover:-moz-placeholder { color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>  ; }
		.gewicht_pat .gewicht_form .form_box li input.inp:hover::-moz-placeholder { color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>  ; }
		.gewicht_pat .gewicht_form .form_box li input.inp:hover:-ms-input-placeholder { color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>  ; }
		...
		.ui-slider-handle.ui-state-default.ui-corner-all.ui-state-hover:hover svg circle{
			fill: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;;
		}
		/*--Check out page--*/
		...
		{
			background-color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important ;
		    border: 1px solid <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;
		...
		.toggle-btn:hover {
   				border: solid 1px <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;
   				color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?>;
   		}
		...
		{    border-color:<?php echo esc_html($shopkeeper_theme_options['main_color']); ?> transparent transparent;;
		}
		.faq_show.faq_main_page .faq_details .welter_btn a { background: <?php echo esc_html($shopkeeper_theme_options['main_color']); ?> none repeat scroll 0px 0px ; border: 1px solid <?php echo esc_html($shopkeeper_theme_options['main_color']); ?> ;}

		.top_price:after{border-top-color: <?php echo esc_html($shopkeeper_theme_options['main_color']); ?>;}
		.testimonial_slider .white .wpb_content_element .testimonial_rotator_wrap .testimonial_rotator .has-image .text p.testimonial_rotator_weight_badge,.welter_btn a{color:<?php echo esc_html($shopkeeper_theme_options['main_color']); ?>;border: 1px solid <?php echo esc_html($shopkeeper_theme_options['main_color']); ?>;}
		/*---Checkout---*/
		.woocommerce .checkout #order_review .form-row.place-order input#place_order.button{
		background: <?php echo esc_html($shopkeeper_theme_options['main_color']); ?> !important;
    	border: 1px solid <?php echo esc_html($shopkeeper_theme_options['main_color']); ?> !important
		}
		/*---------------------*/
