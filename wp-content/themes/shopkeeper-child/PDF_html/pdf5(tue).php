...
<?php 
	...
	$tue_meal_res=$wpdb->get_results('select tue from up_plan_logs where user_nutrition_plan_id='.$order_details[0]->id.' AND week_no='.$week_no.' AND site_id='.$site_id);	
...
//	print_r($breakfast_kcal);
	...
	foreach($meat_meals2 as $k=>$v){
	  ...
	  ?>
     <div style="background:#f0eeef;text-align:center;overflow:hidden; color:#70848e;margin:0px;">
