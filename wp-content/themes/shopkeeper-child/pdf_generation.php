...
//$no_of_weeks=2;	
		...
		// mode, format, default_font_size, default_font, margin_left, margin_right,
			...
			$header3=__('<div style="padding:0px 0px 0px 0px;width:100%;background:#FFF;border:0;outline:none;margin:0;">
		...
		*/
			...
			$pdfpath=$path['path'].'/'.'pdf/'.$plan_name.'__Ernährungsplan__'.$billing_first_name.'_'.$billing_last_name.'_'.$order_id.'.pdf';
