...
<h2 style="color:#162c5d;padding-top:80px; font-size:24px;line-height: 24px; border-bottom:10px solid #fff; margin:0 auto;font-weight: normal;"><?php printf( __( 'Bestellnummer: %s', 'woocommerce' ), $order->get_order_number() ); ?></h2>
