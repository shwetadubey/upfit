...
$this->margBuffer = 8;			// Allows an (empty) end of block to extend beyond the bottom margin by this amount (mm)
...
$this->collapseBlockMargins = false; 	// Allows top and bottom margins to collapse between block elements
