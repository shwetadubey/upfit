...
<?php
/*
Template Name:Woocommerce thank you page(Center part only)
*/
?>
...
<?php get_header(); ?>
	...
	<div class="full-width-page <?php echo ( (isset($page_title_option)) && ($page_title_option == "on") ) ? 'page-title-shown':'page-title-hidden';?>" style="max-width:620px">
