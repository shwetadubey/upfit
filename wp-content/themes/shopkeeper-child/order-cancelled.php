											...
											<div class="xlarge-12 xlarge-centered large-8 large-centered columns">
												<?php $lines = explode(".",do_shortcode('[tooltip_id id=35]')); ?>
													<p class="text-light cancel_order_text"><?php echo $lines[0].'.';?>
														<a href="<?php echo get_permalink(63); ?>" ><?php echo $lines[1]; ?></a>
													</p>
													<div class="blue_hover">
														<a href="<?php echo home_url(); ?>" class="vc_btn3" style="background-color:#2cab50; color:#ffffff;"><?php echo do_shortcode('[tooltip_id id=57]') ?><i class="fa fa-angle-right"></i></a>
													</div>
